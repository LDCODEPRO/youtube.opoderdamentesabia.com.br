...
- **Quantidade de posts: 3 vídeos/semana — DOMINGO 10:00, QUARTA 19:00 e SEXTA 19:00** (ciclo ditado pelo Diretor em 17/07/2026; horários assinados pelo Pesquisador em `data/agenda_canal.json`, com fontes). O Pesquisador mede as primeiras 24h de cada estreia e revê os horários toda segunda; slot que perder por 4 semanas entra em julgamento (proposta de troca vai ao Diretor). Se a qualidade cair para cumprir o ritmo, corta-se para 2/semana — consistência vale mais que quantidade.
